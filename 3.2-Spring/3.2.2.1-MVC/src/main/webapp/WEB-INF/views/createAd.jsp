...
<div class="container">
    ...
    <form:form id="form" action="${pageContext.servletContext.contextPath}/ad/createAd.do" method="post" enctype="multipart/form-data" onsubmit="return validate()">
        ...
        <div>
            <div class="form-group">
                ...
                <select class="col-xs-2" id ="brand" title="Select brand." name="car.brand.id">
            ...
            <div class="form-group">
                ...
                <input type="text" class="col-xs-2" id="model" title="Enter car's model." name="car.model">
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="vin">Enter vin:</label>
                <input type="text" class="col-xs-2" id="vin" title="Enter car's vin." name="car.vin">
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="carbody">Select carbody:</label>
                <select class="col-xs-2" id ="carbody" title="Select carbody." name="car.carbody.id">
            ...
            <div class="form-group">
                ...
                <input type="color" class="col-sm-2" id="color" value="#ffffff" name="car.color">
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="engine">Select engine:</label>
                <select class="col-xs-2" id ="engine" title="Select engine." name="car.engine.id" >
            ...
            <div class="form-group">
                ...
                <input type="text" class="col-xs-2" id="power" title="Enter engine's power." name="car.power"> л.с.
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="transmission">Select transmission:</label>
                <select class="col-xs-2" id ="transmission" title="Select transmission." name="car.transmission.id">
            ...
            <div class="form-group">
                ...
                <input class="col-xs-2" type="file" name="photos" multiple accept="image/*" id="photo">
            </div>
            <br>
