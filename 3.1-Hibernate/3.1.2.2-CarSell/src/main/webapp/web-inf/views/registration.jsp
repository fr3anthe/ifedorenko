...
<html lang="en">
    ...
    <body style="background-color: darkseagreen;" id="LoginForm">
        ...
        <form action="${pageContext.servletContext.contextPath}/registration" method="post" onsubmit="return validateRegistration()">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" id="passwordS" title="Confirm password" placeholder="Confirm password">
            </div>
            <div class="form-group">
